<?php require_once("../../CREDS/database.php"); ?>  <!-- CONNECT TO THE DATABASE -->
<?php 
...
<script type="text/javascript">window.location = "reg-confirmation.php"</script> <!-- Reference 3 - StackOverflow, 2017 -->
